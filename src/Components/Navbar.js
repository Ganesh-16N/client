    ...
    <div className="bg-gray-800 p-4 mb-4 flex flex-col md:flex-row items-center justify-between">
      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
        <input
          ...
          className="w-full md:w-auto px-4 py-2 border border-gray-600 rounded focus:outline-none"
        />
        ...
        <div className="flex items-center space-x-4 text-black">
          <label className="flex items-center">
            ...
            <select
              ...
              className="ml-2 px-2 py-1 border border-gray-600 rounded focus:outline-none"
            >
          ...
          <label className="flex items-center">
            ...
            <select
              ...
              onChange={(e) =>
                onAvailabilityChange(e.target.value === '' ? null : e.target.value === 'true')
              }
              className="ml-2 px-2 py-1 border border-gray-600 rounded focus:outline-none"
            >
              <option value="">All</option>
